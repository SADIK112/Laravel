    ...
    <div class="col-lg-12">
        ...
        <div class="well">
            ...
            <div class="form-group">
                ...
                <div class="col-sm-10">
                    <input type="number" class="form-control" name="productPrice" value="productPrice">
            ...
            <div class="form-group">
                ...
                <div class="col-sm-10">
                    <input type="number" class="form-control" name="productQuantity" value="productQuantity">
