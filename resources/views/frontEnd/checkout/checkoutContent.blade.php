...
<html>
    ...
    <body>    
       ...
       <div class="container">
           <div class="row">
               <div class="col-lg-12">
                   <div class="well lead text-center text-success">you have to login to complete your order.If you are not register then Sign Up first</div>
               </div>
           </div>
       </div>
       <br>
       <div class="container">
            <form class="form-horizontal" method="POST" action="{{url('/checkout/sign-up') }}" role="form">
            {!! csrf_field() !!}
                ...
                <div class="form-group">
                   ...
                   <div class="form-group">
                    ...
                    <div class="col-sm-9">
                        <textarea rows="10" cols="20" name="Message" placeholder="Message" class="form-control"></textarea>
                    </div>
                </div>
                  <div class="form-group">
                    <div class="col-sm-9">
